...
See the [how to submit a job]({% link docs/slurm/how-to_submit_a_job.md %}) and [how to start an interactive job]({% link docs/slurm/how-to_start_an_interactive_job.md %}) pages for more details on running jobs.
