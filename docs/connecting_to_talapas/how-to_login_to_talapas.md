...
See the [How-to Run an X11 Application]({% link docs/software/how-to_run_an_x11_app.md %}) page for more details on running an X11 program on a compute node.
