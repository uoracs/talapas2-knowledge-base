...
| `Mathematica` | `Mathematica/11.3, Mathematica/12.0` |
| `NonLinLoc` | `NonLinLoc/20221102` |
| `OpenDX` | `OpenDX/4.4.4` |
| `R` | `R/3.4.2-lcni, R/4.3.2, R/4.3.3, R/4.4.2` |
| `RECON` | `RECON/1.08` |
...
| `adapterremoval` | `adapterremoval/2.1.7, adapterremoval/2.3.3` |
| `afni` | `afni/24.1.22` |
| `alphafold3` | `alphafold3/3.0.0` |
| `amber` | `amber/22` |
| `ancestry_hmm` | `ancestry_hmm/0.92-old, ancestry_hmm/0.92` |
...
| `bamm` | `bamm/2.5.0` |
| `bamtools` | `bamtools/2.4, bamtools/2.5.1` |
| `bayestraits` | `bayestraits/3.0.2` |
| `bbmap` | `bbmap/38.16, bbmap/39.06` |
| `bcftools` | `bcftools/1.18, bcftools/1.19` |
| `beagle` | `beagle/5.4` |
| `bedops` | `bedops/2.4.41` |
| `bedtools` | `bedtools/2.25.0` |
| `bgc` | `bgc/1.0.3-patched, bgc/1.0.3` |
| `bgchm` | `bgchm/1.0.0` |
| `blast` | `blast/2.2.29+, blast/2.14.1+` |
| `bowtie2` | `bowtie2/2.3.3, bowtie2/2.4.4` |
| `brainiak` | `brainiak/20240412` |
| `braker` | `braker/2.0, braker/2.1.0, braker/2.1.3-WIP-20190826` |
...
| `datascience` | `datascience/20200826, datascience/20201104` |
| `dataselect` | `dataselect/3.22` |
| `dcm2bids` | `dcm2bids/3.1.1, dcm2bids/3.2.0` |
| `dcm2niix` | `dcm2niix/1.0.20200331, dcm2niix/1.0.20230411, dcm2niix/15, dcm2niix/20240416` |
| `dcmtk` | `dcmtk/3.6.8` |
| `dcmtk-src` | `dcmtk-src/3.6.8` |
| `deepvariant` | `deepvariant/0.6.1, deepvariant/1.1.0` |
| `diamond` | `diamond/0.8.22, diamond/0.9.10` |
| `diploshic` | `diploshic` |
...
| `fmf` | `fmf/1.5.0` |
| `fmriprep` | `fmriprep/23.2.0, fmriprep/23.2.1` |
| `freebayes` | `freebayes/1.3.1` |
| `freesurfer` | `freesurfer/6.0.0, freesurfer/7.2.0, freesurfer/7.3.0, freesurfer/7.3.2, freesurfer/7.4.1` |
| `fsl` | `fsl/5.0.9, fsl/5.0.10, fsl/6.0.1, fsl/6.0.7, fsl/6.0.7.9` |
| `fsleyes` | `fsleyes/0.23.0` |
| `fxtract` | `fxtract` |
| `gambit_bsm` | `gambit_bsm/2.4.4-miniconda3, gambit_bsm/2.4.4` |
| `gamess` | `gamess/Jun302023R1` |
| `gamess-us` | `gamess-us/20180930-R3` |
| `gaussian` | `gaussian/g09e01` |
| `gcc` | `gcc/8.5.0, gcc/13.1.0` |
| `gcta` | `gcta/1.94.4` |
| `genemark` | `genemark/4.33, genemark/4.46, genemark/4.71` |
| `genomethreader` | `genomethreader/1.7.0, genomethreader/1.7.1` |
| `geos` | `geos/3.6.2` |
| `gephi` | `gephi/0.9.2` |
| `globus` | `globus/3.26.0` |
| `gmap-gsnap` | `gmap-gsnap/2017-09-11, gmap-gsnap/2025-04-19` |
| `golang` | `golang/1.12.1, golang/1.16.3, golang/1.21.3, golang/1.22.0, golang/1.24.0` |
| `grace` | `grace/5.1.25` |
| `gromacs` | `gromacs/2019.1, gromacs/2023.1, gromacs/2023.4, gromacs/2024.1, gromacs/2024.3-plumed-2.9.3-cuda-12.4.1-pytorch, gromacs/2024.3-plumed-2.11.0-cuda-12.4.1, gromacs/2024.3-plumed-2.11.0` |
| `gurobi` | `gurobi/9.5.1` |
| `haploview` | `haploview/4.2` |
| `hdf5` | `hdf5/1.8.13, hdf5/1.8.19, hdf5/1.14.1` |
| `hmmer` | `hmmer/3.1b2` |
| `homer` | `homer` |
| `hpcx` | `hpcx/v1.8.0-ompi-v2.x, hpcx/v1.8.0-stack` |
| `hypre` | `hypre/2.28.0` |
...
| `issm` | `issm/4.21, issm/4.24` |
| `itksnap` | `itksnap/3.6.0` |
| `java` | `java/1.8.0, java/17.0.10` |
| `jq` | `jq/1.6` |
| `julia` | `julia/0.6.2, julia/1.1.1, julia/1.3.1, julia/1.5.1, julia/1.6.3, julia/1.8.5, julia/1.10.3` |
...
| `maker` | `maker/2.31.9` |
| `mango` | `mango/4.1` |
| `matlab` | `matlab/R2016b, matlab/R2017b_pas, matlab/R2017b, matlab/R2018b, matlab/R2019b, matlab/R2020b, matlab/R2021a, matlab/R2022a, matlab/R2024a` |
| `maven` | `maven/3.5.0` |
| `maxssmap` | `maxssmap/v1` |
| `merlin` | `merlin/1.1.2` |
| `mesos` | `mesos/1.9.0` |
| `metabat` | `metabat/2.12.1` |
| `mfix` | `mfix/23.2, mfix/24.1.1` |
...
| `mriqc` | `mriqc/0.16.1, mriqc/24.0.0-conda, mriqc/24.0.0, mriqc/24.0.2` |
| `mrtrix` | `mrtrix/MRtrix3Tissue, mrtrix/3.0_RC3, mrtrix/3.0.4` |
...
| `ncbi_cxx` | `ncbi_cxx/17, ncbi_cxx/18, ncbi_cxx/21` |
| `ncview` | `ncview/2.1.11` |
| `neovim` | `neovim/0.9.1` |
| `netcdf` | `netcdf/4.9.2, netcdf/4.9.3-intel, netcdf/4.9.3` |
| `netcdf-fortran` | `netcdf-fortran/4.6.1, netcdf-fortran/4.6.2-intel` |
| `ngsolve` | `ngsolve/6.2.2102` |
| `ngsrelate` | `ngsrelate/v2` |
| `nipype` | `nipype/nipype-old, nipype/nipype, nipype/1.8.6-20240503` |
| `node` | `node/20.16.0` |
| `nvhpc` | `nvhpc/22.2, nvhpc/25.7` |
...
| `openmpi` | `openmpi/2.1, openmpi/3.1, openmpi/4.1.5, openmpi/4.1.6` |
| `orca` | `orca/6.0.1, orca/6.1.0` |
| `orfm` | `orfm/0.7.1` |
| `ovito` | `ovito/3.13.1` |
| `papi` | `papi/5.5.1` |
| `parallel` | `parallel/20241222` |
| `paraview` | `paraview/5.7.0, paraview/5.8.1, paraview/5.9.0-RC2, paraview/5.9.0, paraview/5.11.0-RC2, paraview/5.11.0, paraview/5.13.0, paraview/5.13.1, paraview/6.0.0` |
| `pasa` | `pasa/2.3.3` |
...
| `psass` | `psass/3.1.0, psass/3.1.0-20240411, psass/3.1.0-20240424` |
| `psmc` | `psmc/0.6.5` |
| `pycharm` | `pycharm/2020.1.2, pycharm/2022.3` |
| `pyfftw3` | `pyfftw3/3.3.10` |
| `pylith` | `pylith/4.0.0` |
| `pymer4` | `pymer4/20240321, pymer4/20240410` |
| `pypi-env` | `pypi-env/pypi-env` |
| `pypi-packages` | `pypi-packages/pypi-packages` |
| `python` | `python/2.7.18` |
| `python2` | `python2/2.7.13, python2/2.7.14-old, python2/2.7.14, python2/2.7.15, python2/2.7.17` |
| `python3` | `python3/3.6.1, python3/3.6.5, python3/3.6.7, python3/3.6.9, python3/3.7.5, python3/3.10.13, python3/3.11.4` |
...
| `rclone` | `rclone/1.38, rclone/1.52.2, rclone/1.66.0, rclone/1.70.3` |
...
| `rstudio` | `rstudio/base, rstudio/rstudio-cont, rstudio/2022.07.1+554, rstudio/2023.12.1+402, rstudio/2024.04.1+748-condaGLIBX, rstudio/2024.04.1+748-gdalgeos-20250121, rstudio/2024.04.1+748, ...` |
| `rstudio-bare` | `rstudio-bare/1.3, rstudio-bare/2022.07.1+554` |
| `ruby` | `ruby/2.4.3` |
| `rust` | `rust/1.82` |
...
| `spades` | `spades/3.13.0, spades/3.15.3` |
| `specfem3d` | `specfem3d/3.0-gpu, specfem3d/20190918-devel` |
| `spines` | `spines/1.15` |
| `stable-diffusion` | `stable-diffusion/stable-diffusion` |
| `stacks` | `stacks/2.0b, stacks/2.68` |
| `star` | `star/2.7.11b` |
| `stata` | `stata/17, stata/18` |
| `strace` | `strace/4.26` |
| `subread` | `subread/1.6.0, subread/2.0.6` |
| `sw4` | `sw4/3.0.0` |
| `tau` | `tau/2.33.2` |
...
| `usearch` | `usearch/8.0, usearch/11.0` |
| `vasp` | `vasp/agnelab-6.5.1, vasp/nazingroup-6.5.1, vasp/racs-6.5.1` |
