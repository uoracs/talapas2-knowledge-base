...
Running a container is similar to running a regular job in SLURM. Please visit [How-to Submit a Job]({% link docs/slurm/how-to_submit_a_batch_job.md %}) for further information on general job submission.
