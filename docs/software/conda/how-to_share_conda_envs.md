...
Once you have verified your `environment.yml` file and everything looks good, you are ready to share it with others! Creating conda environments from `environment.yml` files is simple and a guide can be found in the [How-to Create Personalized Conda Environments]({% link docs/software/conda/how-to_create_personal_conda_envs.md %}) page.
